...
def execute_pipeline():
    ...
    # YouTube-specific fields (now generated by Brain 3)
    yt_title = script_data.get("youtube_title", script_data.get("thumbnail_text", "Must Watch 🔥"))
    yt_tags = script_data.get("youtube_tags", [t.strip('#') for t in tags if isinstance(t, str) and t.startswith('#')])
